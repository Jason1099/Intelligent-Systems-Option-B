...
class image_segmentation:
    ...
    def segmentation(self, gray):
        # Try multiple binarization methods and pick the best
    ...
    def _best_binarization(self, gray):
        ...
        # Method 3: Simple threshold based on mean
        ...
        for bw in methods:
            ...
            if 3 <= num_labels-1 <= 20:
                score = min(num_labels-1, 20-(num_labels-1))
                if score > best_score:
                    best_score = score
                    best_bw = bw
    ...
    def _filter_components(self, stats, num_labels, image_shape):
        ...
        for i in range(1, num_labels):
            ...
            if x < 2 or y < 2 or x+w > image_shape[1]-2 or y+h > image_shape[0]-2:
                if area < med_area * 0.5: 
                    continue
